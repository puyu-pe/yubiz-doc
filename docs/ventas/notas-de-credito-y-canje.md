# Emitir una nota de crédito o canjear un documento
...
El flujo de canje envía los datos para registrar un nuevo documento y después intenta comunicarlo e imprimirlo. La fuente expone una opción para generar nota de crédito en determinados documentos. La validez, aceptación y efectos fiscales requieren runtime.
...
- Tipos de documento, series y accesos habilitados.
- Rango de fecha y validaciones configuradas.
- Registro, comunicación, impresión y efectos fiscales u operativos.
